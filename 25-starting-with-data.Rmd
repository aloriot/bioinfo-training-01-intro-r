...
| external_gene_name  | The name of the gene in the ENSEMBL database                                        |
...
download.file(url = "https://raw.githubusercontent.com/Bioconductor/bioconductor-teaching/master/data/GSE96870/rnaseq.csv", destfile = "data/rnaseq.csv")
# if (!file.exists("data/rnaseq.csv"))
#     download.file(url = "https://raw.githubusercontent.com/UCLouvain-CBIO/bioinfo-training-01-intro-r/main/data/rnaseq.csv",
...
rna[-c(7:32428), ] ## Equivalent to head(surveys)
```
