...
- Understand the importance of keys in joins and the implications of using 
non-unique keys
...
tables to enable and automatic join with the two keys.
...
same rownames (even if they have the same number of columns)
