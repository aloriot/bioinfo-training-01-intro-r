...
|             | Tuesday 28-9-21                                                  | Thursday 30-9-21                     |
| ----------- | ---------------------------------------------------------------- | ------------------------------------ |
| 9h-10h30    | Data organisation with Spreadsheets<br>R and Rstudio             | Data visualization                   |
| 10h45-12h45 | Introduction to R<br>Starting with data                          | Data visualization<br>Joining tables |
| 13h45-15h45 | Starting with data<br>Manipulating and analyzing data with dplyr | Summary exercise                     |
...
This training is organised by the SMCS in partnership with laurent Gatto, from the [CBIO Lab](https://lgatto.github.io/cbio-lab/) in the de Duve Institute and is being taught by Axelle Loriot and Manon Martin at the UCLouvain, Belgium.
...
[https://github.com/UCLouvain-CBIO/bioinfo-training-01-intro](https://github.com/UCLouvain-CBIO/bioinfo-training-01-intro)
and the compiled material can be read at https://uclouvain-cbio.github.io/bioinfo-training-01-intro/.
