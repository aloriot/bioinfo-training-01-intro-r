...
including operations assignments, etc. Many functions are predefined, can be
made available by importing R *packages* (more on that later) or can be built by the user. 
...
* from 1 to 100 with steps of 3, 
* from 50 to 10 of length 8
`r msmbstyle::question_end()`
...
# from 1 to 100 with steps of 3
seq(1,100, by = 3)
# from 10 to 50 of length 8
seq(50,10, length.out = 8)
```
